...
def vgg_gap(image, sn=True):
    ...
    l = tf.nn.max_pool(l, ksize=[1,2,2,1], stride=[1,2,2,1], padding='SAME', name='pool1')
    ...
    l = tf.nn.max_pool(l, ksize=[1,2,2,1], stride=[1,2,2,1], padding='SAME', name='pool2')
    ...
    l = tf.nn.max_pool(l, ksize=[1,2,2,1], stride=[1,2,2,1], padding='SAME', name='pool3')
    ...
    l = tf.nn.max_pool(l, ksize=[1,2,2,1], stride=[1,2,2,1], padding='SAME', name='pool4')
